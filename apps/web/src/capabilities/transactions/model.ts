...
export const journalEntrySchema = z.object({
  ...
  finalityStatus: z.enum(['UNFINALIZED', 'FINALIZED', 'UNKNOWN']).optional(),
  finalizedHeadNumber: unsignedIntegerSchema.optional(),
  finalizedHeadHash: bytes32Schema.optional(),

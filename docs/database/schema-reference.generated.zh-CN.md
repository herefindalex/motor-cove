...
[English](schema-reference.generated.md) · [繁體中文](schema-reference.generated.zh-TW.md)

> 本页译自根据可执行 Drizzle migration 历史生成的[英文 schema 参考](schema-reference.generated.md)。运行 `pnpm docs:generate` 更新英文原文后，请同步检查此译本。

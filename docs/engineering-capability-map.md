...
| CAP-10 | Event-driven backend | implemented | RUN-INDEXER-UNIT: executed/pass<br>RUN-INDEXER-KILL: executed/pass<br>RUN-INTEGRATION: executed/pass | Automatic recovery across arbitrary canonical branch changes remains outside scope; incomplete rebuild source requires explicit reindex. |

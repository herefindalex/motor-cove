...
| CAP-11 | Database lifecycle | partial | RUN-DB-MIGRATIONS: executed/pass<br>RUN-DB-BOUNDARIES: executed/pass<br>RUN-DB-SEEDS: executed/pass<br>RUN-DB-RECOVERY: executed/pass<br>RUN-CHAIN-SEED-JOURNAL: executed/pass<br>RUN-INTEGRATION: executed/pass<br>RUN-MANAGED-NODE-OWNERSHIP: executed/pass | A real process kill in the broadcast-to-hash persistence window and other listed database fault-injection cases remain incomplete. |

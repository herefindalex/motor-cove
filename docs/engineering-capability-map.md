...
| CAP-13 | Failure diagnosis and recovery | partial | RUN-TRANSACTION-RECOVERY: executed/pass<br>RUN-INDEXER-KILL: executed/pass<br>RUN-INTEGRATION: executed/pass<br>RUN-DB-RECOVERY: executed/pass | Hardware power loss, cross-device journal recovery, and some filesystem fault cases remain unverified. |

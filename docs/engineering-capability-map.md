...
| CAP-06 | Transaction lifecycle | implemented | RUN-TRANSACTION-RECOVERY: executed/pass<br>RUN-INTEGRATION: executed/pass<br>RUN-E2E: executed/pass | Non-durable known-hash tracking survives only in the current tab; automated recovery uses local Anvil or controlled ports, while real MetaMask response loss and every replacement variant remain unverified. |
...
| CAP-13 | Failure diagnosis and recovery | partial | RUN-TRANSACTION-RECOVERY: executed/pass<br>RUN-INDEXER-KILL: executed/pass<br>RUN-INTEGRATION: executed/pass<br>RUN-DB-RECOVERY: executed/pass | Projection interruption through ordinary process SIGKILL is verified; hardware power loss, cross-device journal recovery, and some filesystem fault cases remain unverified. |

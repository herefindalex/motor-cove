...
| CAP-06 | Transaction lifecycle | implemented | RUN-TRANSACTION-RECOVERY: executed/pass<br>RUN-INTEGRATION: executed/pass<br>RUN-E2E: executed/pass | Non-durable known-hash tracking survives only in the current tab. Cross-device journal coordination and manual MetaMask response-loss testing are not claimed. |

...
2. Resolve real paths, reject symlinks/external paths, then acquire exclusive service and writer locks.
...
lock inodes and backups. These checks do not prove resistance to a malicious process impersonating
Anvil on loopback.
